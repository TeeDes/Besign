...
const Messages = () => {
  ...
  const mutation = useMutation({ //useMutation để đánh dấu các cuộc trò chuyện là đã đọc khi người dùng nhấn nút "Đánh dấu đã đọc".
    mutationFn: (id) => {
  ...
  const handleRead = (id)=>{ //handleRead: Hàm xử lý sự kiện khi người dùng nhấn nút "Đánh dấu đã đọc".
    mutation.mutate(id);
  };
