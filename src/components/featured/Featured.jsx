...
const Featured = () => {
    const [input,setInput] = useState(""); //Sử dụng useState để tạo state input để lưu trữ giá trị của ô input.
            ...
            <div className="left">
                ...
                <div className="search">
                    <div className="searchInput">
                        ...
                        onChange={e=>setInput(e.target.value)}  //Mỗi lần người dùng thay đổi giá trị của ô input, state input sẽ được cập nhật
                        />
                    </div>
